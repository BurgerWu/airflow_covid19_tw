...
class UpdateCasesTableOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        case_table['個案研判日'] = pd.to_datetime(case_table['個案研判日'])
        ...
        to_update_case = case_table[case_table['個案研判日'] > datetime(latest_record.year, latest_record.month, latest_record.day)]
